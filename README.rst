...
.. doctest::
    ...
    ['b_compensate_distance', 'driver_mass', 'f0', 'f1', 'f2', 'f_dsc_decimals', 'f_dsc_threshold', 'f_inertial',
...
- Finally, since all phases start and end with consecutive zeros(0),
...
------------------  -------------------  ------------------   --------  -----------
*class*  *part*     *V*    *VA0*  *VA1*  *V*   *VA0*  *VA1*   *V*       *V*
=======  =========  =====  =====  =====  ====  =====  =====   ========  ===========
class1   **part1**  9840   4438   97DB   9840  4438   97DB    11988.4   11988.4
\        **part2**  8C34   8C8D   D9E8   DCF2  090B   4295    17162.8   29151.2
\        **part3**  9840   4438   97DB   6D1D  4691   F523    11988.4   41139.6
...
\        **part4**  8994   0D25   2181   474B  262A   F70F    28869.8   81536.9
...
\        **part4**  F962   1A0A   5177   9BCE  9853   2B8A    29714.9   83496.9
