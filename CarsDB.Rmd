...
It builds this *inputs* parts (`props`, `pwot`) of the following tree 
as a [HDF5 file](https://pandas.pydata.org/pandas-docs/stable/user_guide/io.html#io-hdf5)
(see `README.py`).
...
#
prov_info = nbu.provenance_info(files=[xlfname], prov_info=root_prov_info)
...
prov_info = nbu.provenance_info(prov_info=root_prov_info)
scalar_columns = [
    "Calculation date",
