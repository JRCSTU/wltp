...
mdl['wot'] = pd.read_csv(io.StringIO("""
n	p
1000	18.80
1250	34.00
1500	51.80
...
```{python}
ax = mdl['cycle_run'][['v_cycle', 'v_target']].plot()
ax = mdl['cycle_run'][['p_req', 'p_avail']].plot(ax=ax, secondary_y=True)
```
