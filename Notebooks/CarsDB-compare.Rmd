...
datags_to_collect = ("props", "out1/props", "out1/cycle", "out2/props", "out2/cycle")

ip1, p1, c1, p2, c2 = merge_veh_datasets(h5fname, datags_to_collect, vehgroups_with_out1)
...
## Set level-2 indexs cycle-time, to plot nicely,
#  bc they Heinz-DFs were not stored with time as index 
#  (was just a column).
#
c1['vg'] = c1.index.droplevel(1)
c1 = c1.set_index(['vg', 'tim'])
```
...
display(grid(cdf, fitcols=False, cwidth=100),)
```
...
#
cols1 = ["v_orig", "v", "g_max", "gear", "P_tot", "P_max", "n_kl"]
