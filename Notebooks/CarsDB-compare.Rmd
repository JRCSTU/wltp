...
def load_heinz_and_python_datasets():
...
p1, c1, p2, c2 = load_heinz__and_python_datasets()
```
...
#
# UNCOMMENT to FETCH new vehicles.
...
```{python}
plt.close();
_fig, (ax1, ax2) = plt.subplots(2, sharex=True)

veh, col1, col2 = 'v075 P_tot p_required'.split()
a, b = c1.loc[veh, col1], c2.loc[veh, col2]
