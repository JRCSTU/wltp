...
#
# > **TIP:**
# > Navigate with the *headers* of this notebook, by installing the **`@jupyter/toc`** extension 
...
# %% [markdown]
# ## Compare with "execed" results with output files from `run_all_cases.m`
...
# %% [markdown]
# **NOTE:** COMPARE CHEKCSUMS already hapened after SCALE was executed.
